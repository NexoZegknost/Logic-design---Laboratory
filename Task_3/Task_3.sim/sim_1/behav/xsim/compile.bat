...
REM
REM Generated by Vivado on Thu May 21 10:38:51 +0700 2026
...
echo "xvlog --incr --relax -prj top_string_mode_tb_vlog.prj"
call xvlog  --incr --relax -prj top_string_mode_tb_vlog.prj -log xvlog.log
