...
REM
REM Generated by Vivado on Thu May 21 10:15:05 +0700 2026
...
echo "xvlog --incr --relax -prj Task_1_TB_vlog.prj"
call xvlog  --incr --relax -prj Task_1_TB_vlog.prj -log xvlog.log
