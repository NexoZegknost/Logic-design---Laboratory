...
REM
REM Generated by Vivado on Thu May 21 00:54:17 +0700 2026
...
echo "xvlog --incr --relax -prj Task_2_TB_vlog.prj"
call xvlog  --incr --relax -prj Task_2_TB_vlog.prj -log xvlog.log
